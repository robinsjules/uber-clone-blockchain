...
const style = {
    wrapper: `pt-2`,
    searchHeader: `w-full font-bold text-black text-left flex items-center text-3xl p-4 overflow-hidden`,
    inputBoxes: `flex flex-col mb-4 relative text-black`,
    inputBox: `h-10 mx-4 border-2 bg-[#eeeeee] rounded-2xl flex items-center my-1 py-1 px-2`,
    ...
    return (
        <div className = {style.wrapper}>
            <div className={style.searchHeader}>
                {inFocus === 'from' ? 'Where can we pick you up?' : "Where is your destination?"}
            </div>
